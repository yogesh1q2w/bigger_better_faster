...
class DataEfficientAtariRunner(run_experiment.Runner):
    ...
    def _run_parallel(self, envs, episodes=None, max_steps=None, one_to_one=False, needs_reset=True, resume_state=None):
        ...
        while True:
            ...
            while b < len(live_envs):
                ...
                if envs[env_id].game_over or envs[env_id].cum_length == self._max_steps_per_episode:
                    total_episodes += 1
                    ...
                    print()
                    print(
                        "Steps executed: {} ".format(total_steps)
...
class LoggedDataEfficientAtariRunner(DataEfficientAtariRunner):
    ...
    def __init__(self, base_dir, create_agent_fn, load_replay_dir=None, save_replay=False):
